...
module.exports = function (grunt) {
    ...
    if (process.argv[2] == 'rename') {
        ...
        if (!newname) {
            console.log('Please write the new paw name, like: "grunt rename --name=mywidgetset" --author="Author Name"');
            process.exit();
        }
        ...
        if (fs.existsSync(__dirname + '/admin/paw.png')) {
            fs.renameSync(__dirname + '/admin/paw.png',              __dirname + '/admin/' + newname + '.png');
        }
        if (fs.existsSync(__dirname + '/widgets/paw.html')) {
            fs.renameSync(__dirname + '/widgets/paw.html',           __dirname + '/widgets/' + newname + '.html');
        }
        if (fs.existsSync(__dirname + '/widgets/paw/js/paw.js')) {
            fs.renameSync(__dirname + '/widgets/paw/js/paw.js', __dirname + '/widgets/paw/js/' + newname + '.js');
        }
        if (fs.existsSync(__dirname + '/widgets/paw')) {
            fs.renameSync(__dirname + '/widgets/paw',                __dirname + '/widgets/' + newname);
        }
    }
            ...
            name: {
                options: {
                    patterns: [
                        ...
                        {
                            match: /Paw/g,
                            replacement: newname ? (newname[0].toUpperCase() + newname.substring(1)) : 'Paw'
                        },
                        {
                            match: /bondrogeen/g,
                            replacement: author
